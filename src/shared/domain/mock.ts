...
export const suppliers: SupplierRow[] = [
  {
    ...
    address: "Shah Alam, Lahore",
    notes: "Wire and switches",
    currentBalance: 0,
    isActive: true,
  },
  {
  ...
  },
  {
    ...
    name: "Noor Lights",
    phone: "0301 5566778",
    email: "noor@lights.pk",
    address: "Township",
    notes: "Fans and bulbs",
    currentBalance: 0,
    isActive: true,
  },
  {
...
export const stockMovements: StockMovementRow[] = [
  {
    ...
    type: "PURCHASE",
    quantity: 90,
    referenceType: "ProductLot",
    referenceId: "lot2",
    notes: "New roll stock",
    createdBy: "u3",
  ...
  },
  {
    ...
    type: "RETURN",
    quantity: 2,
    referenceType: "ReturnReplacement",
    referenceId: "rr1",
    notes: "Good condition back to lot",
    createdBy: "u2",
  ...
  },
  {
    ...
    type: "TRANSFER_IN",
    quantity: 40,
    referenceType: "BranchStockTransfer",
    referenceId: "tr1",
    notes: "To warehouse",
    createdBy: "u3",
  ...
  },
  {
    ...
    referenceType: "Production",
    referenceId: "pr1",
    notes: "Assembled fans",
    createdBy: "u4",
    createdAt: "2026-08-11 17:40",
  },
  {
    id: "m10",
    productId: "p8",
...
export const invoices: InvoiceRow[] = [
  ...
  },
  {
    ...
    status: "COMPLETED",
    notes: "Credit sale — deducted from advance later",
    createdBy: "u2",
...
export const moneyTxns: MoneyTxnRow[] = [
  ...
  },
  {
    ...
    amount: 1400,
    paymentMethod: "CASH",
    referenceType: "CustomerLedger",
    referenceId: "ld2",
    notes: "Ahmed balance payment",
    createdBy: "u2",
    createdAt: "2026-08-13 19:00",
  },
  {
  ...
  },
  {
    ...
    amount: 400,
    paymentMethod: "CASH",
    referenceType: "EmployeeCommission",
    referenceId: "ec1",
    notes: "Imran fan job",
    createdBy: "u1",
    createdAt: "2026-08-11 18:00",
  },
];
...
export const devices: DeviceRow[] = [
  {
    ...
    branchId: "b1",
    isActive: true,
    lastSeenAt: "2026-08-25 00:40",
    lastSyncedAt: "2026-08-25 00:38",
  },
  {
    id: "d2",
    name: "Warehouse till",
    branchId: "b2",
    isActive: true,
    lastSeenAt: "2026-08-24 19:12",
    lastSyncedAt: "2026-08-24 19:10",
  },
  {
    id: "d3",
    name: "Old laptop",
    branchId: "b1",
    isActive: false,
    lastSeenAt: "2026-07-02 08:00",
    lastSyncedAt: "2026-07-02 08:00",
  },
];
...
export const syncLogs: SyncLogRow[] = [
  {
    ...
    recordsPulled: 4,
    errorMessage: "",
    startedAt: "2026-08-25 00:38",
    completedAt: "2026-08-25 00:38",
  },
  {
    id: "sy2",
    deviceId: "d2",
    ...
    recordsPushed: 0,
    recordsPulled: 0,
    errorMessage: "Wi-Fi dropped",
    startedAt: "2026-08-24 19:10",
    completedAt: "2026-08-24 19:11",
  },
];
...
export const invoiceNumber = (id: string) =>
