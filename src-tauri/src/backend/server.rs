...
use super::{
    ...
    constants::{
        ...
        PURCHASE_ORDERS_ROUTE, PURCHASE_ORDER_BY_ID_ROUTE, PURCHASE_ORDER_ORDER_ROUTE,
        PURCHASE_ORDER_RECEIVE_ROUTE, REPAIRS_ROUTE, REPAIR_BY_ID_ROUTE, REPAIR_COMPLETE_ROUTE,
        REPAIR_DELIVER_ROUTE, REPAIR_START_ROUTE, REPORTS_ANALYTICS_ROUTE, REPORTS_DASHBOARD_ROUTE,
        RETURNS_ROUTE, RETURN_BY_ID_ROUTE, SALES_COMPLETE_ROUTE, SALES_HOLDS_ROUTE,
        SALES_HOLD_BY_ID_ROUTE, SETTINGS_LOCALIZATION_ROUTE, SETTINGS_PROFILE_ROUTE,
        SETTINGS_RECEIPT_ROUTE, STAFF_LEDGERS_ROUTE, STOCK_MOVEMENTS_ROUTE, STOCK_ROUTE,
        SUPPLIERS_ROUTE, SUPPLIER_ADJUST_BALANCE_ROUTE, SUPPLIER_BY_ID_ROUTE,
        SUPPLIER_LEDGERS_ROUTE, SUPPLIER_LEDGER_ROUTE, SUPPLIER_PAYMENTS_ROUTE, SYNC_STATUS_ROUTE,
        TRANSACTIONS_ROUTE, TRANSFERS_ROUTE, TRANSFER_BY_ID_ROUTE, TRANSFER_RECEIVE_ROUTE,
        TRANSFER_SEND_ROUTE, TRASH_PURGE_ROUTE, TRASH_RESTORE_ROUTE, TRASH_ROUTE, UNITS_ROUTE,
        UNIT_BY_ID_ROUTE, USERS_ROUTE, USER_BY_ID_ROUTE, USER_LEDGER_ROUTE, USER_PAYOUTS_ROUTE,
    },
    db,
    errors::AppError,
    handlers, AppState,
